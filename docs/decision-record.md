...
Open assumptions: Search Console needs time to process crawl, indexing, and performance data; submission does not guarantee indexing. Current demand was manually reviewed; paid keyword metrics remain estimates.
